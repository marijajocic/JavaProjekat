...
/**
 * Inventar je klasa �?ije objekte ćemo koristiti u klasi Firma.
 * 
 * @author Bojana/Milan
 *
 */
public class Inventar {
	...
	public Inventar(int id, String ime, String prostorija, String imePrezime,
			double procenjenaVrednost, int godinaProizvodnje, LocalDate datum) {
		this.id = id;
		this.ime = ime;
	...
	public String toString() {
		...
		return String.format("%15s %15s %15s %20s %10.2f %20s %20s", this.id, this.ime, this.prostorija, this.imePrezime, this.procenjenaVrednost, this.godinaProizvodnje, dtf.format(this.datum));
	}
	
	/*@Override
	public String toString() {
		DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd.MM.yyyy.");
		return "Inventar [id=" + this.id + ", ime=" + this.ime + ", prostorija="
				+ this.prostorija + ", imePrezime=" + this.imePrezime
				+ ", procenjenaVrednost=" + this.procenjenaVrednost
				+ ", datum =" + dtf.format(this.datum) + "]";
	}*/
